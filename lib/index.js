...
const user = chalk.hex('#d7a1ff').bold('root@xynozdev');
const path = chalk.hex('#89CFF0').bold('~/baileys');

console.log(`${user}:${path}$ node index.js`);
console.log(chalk.gray('initializing...'));
console.log(chalk.hex('#a78bfa')('➜  Baileys version : 1.5.0'));
console.log(chalk.hex('#a78bfa')('➜  Creator         : @xynozdev'));
console.log(chalk.hex('#a78bfa')('➜  Status          : ') + chalk.bold.green('ONLINE'));
